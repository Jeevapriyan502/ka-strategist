        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="flex gap-3">
              {[
                { Icon: Facebook, href: "https://www.facebook.com/share/1JhTN6CDFT/", bg: "bg-[#1877F2]", label: "Facebook" },
                { Icon: Instagram, href: "https://www.instagram.com/kastrategist", bg: "bg-gradient-to-tr from-[#F58529] via-[#DD2A7B] to-[#8134AF]", label: "Instagram" },
                { Icon: Youtube, href: "https://youtube.com/@kastrategist", bg: "bg-[#FF0000]", label: "YouTube" },
