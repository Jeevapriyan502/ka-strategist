    ...
    <>
      ...
      {activeSection === "home" && (
        <section className="relative overflow-x-hidden overflow-y-visible bg-gradient-hero">
          <AmbientBackground />
          <div className="container-max relative z-10 min-h-0 px-4 py-12 sm:min-h-[min(88vh,800px)] sm:px-6 sm:py-16 lg:px-8">
            <div className="flex flex-col justify-center">
              <p className="section-label text-reveal text-reveal-d1 text-balance">
              ...
              <div className="mt-3 grid items-center gap-8 lg:grid-cols-[1fr_auto] lg:items-start lg:gap-x-16 xl:gap-x-24">
                ...
                <div className="text-reveal text-reveal-d2 order-1 mx-auto flex w-full justify-center lg:order-2 lg:ml-auto lg:mr-0 lg:max-w-none lg:justify-end">
                  <MarketingHeroVisual />
                </div>
              </div>
